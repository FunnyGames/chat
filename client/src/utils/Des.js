...
function des(key, message, encrypt, padding) {
    ...
    if (padding === 1) { temp = 8 - (len % 8); message += String.fromCharCode(temp, temp, temp, temp, temp, temp, temp, temp); if (temp === 8) len += 8; } //PKCS7 padding
